...
I have not used referencing myself, so I recommend see the appropriate page in the [Quarto docs](https://quarto.org/docs/authoring/citations.html) for further details.
